...
├── scripts/
│   ├── qc/ (FastQC + trimming scripts: `fastp` preferred / FASTX legacy - Member 1)
...
| 6 | Feb 16 | Barcoding readings, **Begin Primary Stage Analysis** | QC on actual project data (FastQC, trimming: `fastp` preferred / FASTX legacy) | Support QC infrastructure decisions | Support data interpretation | Organize raw data | Lab report 3, QC analysis | 33 pts |
